...
describe('authService', () => {
  ...
  it('should return a success response when login succeeds', async () => {
    const mockResponse: LoginSuccessResponse = { token: 'SUCCESS' };
    ...
    const result = await authService.login(dummyLogin);
  ...
  it('should throw an error when login fails', async () => {
    const mockResponse: LoginErrorResponse = { error: 'INVALID_CREDENTIALS' };
